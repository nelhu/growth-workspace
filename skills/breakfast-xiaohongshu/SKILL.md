...
- 只产出内容：最终只输出至少 3 张小红书配图、小红书标题、200 字以内文案、10 个话题标签、互动问题、置顶评论、明天预告、发布描述和本地内容包路径。
...
```json
{
  ...
  "tag_strategy": {
    ...
    "weekly_hot_tag_registry_path": "/Users/you/.breakfast-xiaohongshu/weekly-hot-tags/YYYY-MM-DD.json",
